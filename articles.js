...
const ARTICLES = [
  {
    ...
    extrait: "Trois mois après son lancement, le « Tinder de l'emploi » local dresse un premier bilan encourageant et prépare son hackathon de septembre.",
    contenu: "Trois mois après son lancement, Match'Emploi continue de grandir. La plateforme met en relation les habitants du département avec les entreprises locales qui recrutent, à travers un système de mise en relation simple et rapide.\n\nCe travail collectif, porté par des bénévoles de l'association, avance étape par étape : maquettes, retours utilisateurs, itérations. Le prochain grand rendez-vous est le Hackathon Match'Emploi du 13 septembre à la CCI Portes de Normandie, où designers et développeurs de tous niveaux sont attendus pour une journée de co-création.\n\nSi vous voulez contribuer, que vous sachiez coder ou non, votre place est à cet événement.",
    tempsLecture: 3,
    lien: "",
    labelLien: "",
  },
  {
    id: "art-002",
    titre: "Retour sur l'atelier Git & GitHub pour débutants",
    date: "2026-07-08",
    auteur: "Camille R.",
    categorie: "atelier",
    icone: "bi-git",
    extrait: "Complet en quelques jours, notre atelier d'initiation à Git a réuni quinze participants à BeeCowork autour des bases du contrôle de version.",
  ...
  {
    id: "art-004",
    titre: "Bien choisir son mot de passe : les bons réflexes",
    date: "2026-05-14",
    auteur: "L'équipe A l'Eure Digitale",
    categorie: "tutoriel",
    icone: "bi-shield-lock-fill",
    extrait: "Gestionnaire de mots de passe, double authentification, phrases secrètes : nos conseils simples pour sécuriser ses comptes en ligne sans y passer des heures.",
    contenu: "La sécurité numérique commence souvent par un geste simple : un bon mot de passe. Voici quelques réflexes présentés lors de nos permanences.\n\n1. Préférez une phrase longue et facile à retenir plutôt qu'un mot court truffé de caractères spéciaux.\n2. Utilisez un mot de passe différent pour chaque service important (email, banque, réseaux sociaux).\n3. Activez la double authentification partout où c'est possible, en particulier sur votre messagerie.\n4. Un gestionnaire de mots de passe (même gratuit et open source) vous évite d'avoir à tout retenir par cœur.\n\nCes bonnes pratiques sont abordées plus en détail lors de notre atelier « Sécurité Web », dont une nouvelle édition est régulièrement proposée.",
    tempsLecture: 4,
    lien: "",
    labelLien: "",
  },
